...
# from schema.user_input import ConversationRequest
...
async def lifespan(app: FastAPI):
    ...
    logger.info(
    "application_startup - project: {project_name}, version: {version}, api_prefix: {api_prefix}",
...
async def validation_exception_handler(request: Request, exc: RequestValidationError):
    ...
    """
    logger.error(
    "validation_error - client_host: {client_host}, path: {path}, errors: {errors}",
